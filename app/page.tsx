    ...
    <div className="min-h-screen relative bg-black">
      ...
      <main className="pt-24 pb-12 relative z-20">
        <div className="mx-auto max-w-7xl px-6 space-y-8">
          ...
          <div className="bg-black/60 backdrop-blur-xl rounded-3xl border border-cyan-400/30 shadow-2xl p-6 md:p-8 hover:bg-black/70 transition-all duration-500 hover:shadow-3xl hover:scale-[1.01]">
          ...
          <section id="features">
            <div className="bg-black/60 backdrop-blur-xl rounded-3xl border border-cyan-400/30 shadow-2xl p-8 md:p-12 hover:bg-black/70 transition-all duration-500 hover:shadow-3xl hover:scale-[1.01]">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div id="live-captions" className="text-center p-8 rounded-2xl bg-black/60 backdrop-blur-lg border border-cyan-400/40 shadow-lg hover:shadow-xl transition-all duration-300 hover:bg-black/70 hover:scale-105">
                ...
                <div id="transcript-sync" className="text-center p-8 rounded-2xl bg-black/60 backdrop-blur-lg border border-cyan-400/40 shadow-lg hover:shadow-xl transition-all duration-300 hover:bg-black/70 hover:scale-105">
                  <div className="w-12 h-12 bg-cyan-400/20 rounded-xl flex items-center justify-center mx-auto mb-4">
                    <svg className="w-6 h-6 text-cyan-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path
                        strokeLinecap="round"
                ...
                <div id="video-controls" className="text-center p-8 rounded-2xl bg-black/60 backdrop-blur-lg border border-cyan-400/40 shadow-lg hover:shadow-xl transition-all duration-300 hover:bg-black/70 hover:scale-105">
                  <div className="w-12 h-12 bg-cyan-400/20 rounded-xl flex items-center justify-center mx-auto mb-4">
                    <svg className="w-6 h-6 text-cyan-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path
                        strokeLinecap="round"
            ...
            <div className="bg-black/60 backdrop-blur-xl rounded-3xl border border-cyan-400/30 shadow-2xl p-8 md:p-12 hover:bg-black/70 transition-all duration-500 hover:shadow-3xl hover:scale-[1.01]">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div>
                  ...
                  <div className="space-y-4">
                    <div className="p-6 bg-black/60 backdrop-blur-lg rounded-xl border border-cyan-400/40 shadow-lg hover:shadow-xl transition-all duration-300 hover:bg-black/70 hover:scale-105">
            ...
            <div className="bg-black/60 backdrop-blur-xl rounded-3xl border border-cyan-400/30 shadow-2xl p-8 md:p-12 hover:bg-black/70 transition-all duration-500 hover:shadow-3xl hover:scale-[1.01]">
              ...
              <div className="max-w-4xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="p-8 bg-black/60 backdrop-blur-lg rounded-xl border border-cyan-400/40 shadow-lg hover:shadow-xl transition-all duration-300 hover:bg-black/70 hover:scale-105">
